...
export default function Skills() {
  return (
    <section className="py-32 px-6 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white relative overflow-hidden transition-colors duration-300" id="skills">
